                    ...
                    try {
                        if (error !== undefined) {
                            if (error && error.message) {
                                ...
                                this.logger.error('Failed to send a WebSocket message (error object is null or undefined)');
                            }
                            // Continue execution even if there's an error
                            this.logger.debug(`WebSocket readyState: ${this.websocket.readyState}`);
                            this.logger.debug(`WebSocket bufferedAmount: ${this.websocket.bufferedAmount}`);
                            return resolve();
                        }
                    } catch (e) {
                        this.logger.error(`Exception occurred while sending a WebSocket message: ${e.message}`);
                    }
                    return resolve();
                });
            }
